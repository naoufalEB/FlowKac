...
def get_arguments():
    ...
    parser.add_argument("--reverse_nf_support", action="store_true", help="reverse NF for dynamic density support")
    parser.add_argument("--min_density_support", action="store_true", help="force min value for dynamic density support (avoid negative values for GBM)")
